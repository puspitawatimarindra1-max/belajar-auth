    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <p>Halo <strong>{{ Auth::user()->name }}</strong>, Anda sedang berada di panel administrasi Web Berita. 
                    Gunakan sidebar di sebelah kiri untuk mengelola data pengguna, kategori, dan artikel berita Anda.</p>
                </div>
            </div>
        </div>
    </div>
